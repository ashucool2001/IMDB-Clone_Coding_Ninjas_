        ...
        favouritesList.forEach(movie => {
            ...
            movieCard.innerHTML = `
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-danger btn-sm remove-button" data-imdbid="${movie.imdbID}">Remove Favourites</button>
                    <a href="movie.html?id=${movie.imdbID}" class="btn btn-secondary btn-sm more-button">More Details</a>
                </div>
            `;
